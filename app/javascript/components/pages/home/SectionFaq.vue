<template>
  <div id="faq" class="container py-12">
    ...
    <div class="sm:max-w-md lg:max-w-lg mx-auto">
      ...
      <div class="faq-item">
        <h3 class="faq-item-heading">How many cards should I review each day?</h3>
        <p class="faq-item-content">We recommend reviewing up to 20 cards each day. Reviewing more material may degrade your performance.</p>
      </div>
      <div class="faq-item">
        <h3 class="faq-item-heading">What can I memorize using Spacecards?</h3>
        <p class="faq-item-content">Languages (words, phrases, grammar rules, alphabets & characters), exam questions (facts, dates, formulas), poems, speeches, lines from the script.</p>
      </div>
      <div class="faq-item">
        <h3 class="faq-item-heading">Does it work?</h3>
        <p class="faq-item-content">Spaced repetition is a learning technique that has been studied and researched. <a href="https://en.wikipedia.org/wiki/Spaced_repetition">Further reading</a>.</p>
      </div>
      <div class="faq-item">
        <h3 class="faq-item-heading">Is there an app?</h3>
        <p class="faq-item-content">No. We plan to have iOS and Android apps in the future.</p>
      </div>
      <div class="faq-item">
